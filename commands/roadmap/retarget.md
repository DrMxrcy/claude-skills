...
2. Retarget. Pick **one** selector:
   ...
   and `CHANGELOG.md` (everything now grouped under `--to`), and prunes dates for emptied
   versions. It moves items **regardless of done-state** and does **not** change
   `currentVersion`.
3. Commit the consolidated roadmap:
   ```
